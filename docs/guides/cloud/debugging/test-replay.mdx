...
Test Replay is automatically enabled when updating to `v13` of Cypress and an opt-out is provided through project-level settings. Learn about what this means for [capturing video of test failure](#See-also) in Cypress Cloud.
